    ...
    match ty {
        ...
        syn::Type::Path(path) => {
            ...
            #[cfg(procmacro2_semver_exempt)]
            {
                ...
                // `proc_macro2::Span::source_file()` was removed in newer proc-macro2 releases,
                // and Solana's toolchain often lacks the nightly proc_macro Span file APIs.
                // Use the crate's manifest directory instead; Anchor programs live in `src/lib.rs`.
